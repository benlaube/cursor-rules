...
3. **Check Auth:**
   ...
   - OR does it rely solely on RLS? (This is acceptable _if_ RLS is tight).
...
- _Example:_ "Create a test where User A tries to UPDATE User B's post. Expectation: Row not modified."
...
Produce a report in `/docs/audit/access_control_audit_MM-DD-YYYY.md` containing:
