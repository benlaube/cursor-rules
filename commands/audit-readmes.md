...
- **Last Updated:** 12-04-2025 17:33:38 EST
- **Version:** 1.1.0
...
- **Related Cursor Rules:** [readme-standards.mdc](../rules/readme-standards.mdc), [documentation-metadata.mdc](../rules/documentation-metadata.mdc), [audit-report.mdc](../rules/audit-report.mdc)
...
# 4. Output to console or save to /docs/audit/readme_audit_MM-DD-YYYY.md
```
...
**Note:** This command follows the audit report standards defined in `.cursor/rules/audit-report.mdc` and `standards/project-planning/documentation-management.md` Section 8. Ensure `/docs/audit/` directory exists before generating report.

Save report to:

- `/docs/audit/readme_audit_MM-DD-YYYY.md` - Full report (markdown format, follows audit-report standard)
- Legacy text format (deprecated): `./logs/readme-audit-YYYY-MM-DD-HH-MM-SS.txt` - Full report (use markdown format in `/docs/audit/` instead)
  ...
  "issues": [
    {
      ...
      "type": "Module README",
      "severity": "critical",
      "issues": ["Missing required section: Features", "Missing required section: Dependencies"]
    }
  ]
}
```
...
_This command ensures all README files maintain high quality and follow consistent standards, improving repository documentation and developer experience._
